...
namespace RootInsuranceKata.Logic
{
    public class CustomerFileUploadService
    {
        private List<Driver> ReadFile(string file)
        {
        ...
        public void ReadLine(TextReader reader, List<Driver> drivers)
        {
            string unsplit = reader.ReadLine();
            while (unsplit != null)
            {
                ...
                unsplit = reader.ReadLine();
            }
        }

        public List<DriverDto> UploadFile(string file)
        {
        ...
        //Methods below are for unit tests only
        public List<Driver> ReadFileTest(string data)
        {
            List<Driver> drivers = new List<Driver>();
        ...
        public List<DriverDto> UploadFileTest(string file)
        {
            var drivers = ReadFileTest(file);
